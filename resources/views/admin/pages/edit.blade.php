		        ...
		        <form action="{{ route('page.update', ['id' => $page->id]) }}" method="post" enctype="multipart/form-data">
		        	...
		        	@include('admin.includes.error')
			            <div class="form-group mb-4">
			                <label>Name</label>
			                <input class="form-control form-control-solid" name="name" type="text" placeholder="page Name" value="{{ $page->name }}">
			            </div>
			            <div class="form-group mb-4">
			                <label> Slug <small>(If you leave it empty it will create slug automatically.)</small></label>
			                <input class="form-control form-control-solid" name="slug" type="text" placeholder="Slug for SEO" value="{{ $page->slug }}">
			            </div>
			             <div class="form-group mb-4">
			                <label>Content</label>
			            ...
			            <div class="form-group mb-4">
			                ...
			                <input class="form-control form-control-solid" name="meta_title" type="text" placeholder="Meta Title" value="{{ $page->meta_title }}">
			            </div>
			            <div class="form-group mb-4">
			                <label>Meta Description</label>
			                <textarea class="form-control form-control-solid" name="meta_description" id="meta_description" rows="3" placeholder="Meta Description">{{ $page->meta_description }}</textarea>
			            </div>
