                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="border-radius: 10px;background: #fff;padding: 30px 60px 20px 60px;margin-top: 10px;display: block;">
                                    <p style="font-family: Roboto;font-size: 14px;font-weight: 500;font-style:normal;font-stretch: normal;line-height: 1.71;letter-spacing: normal;color: #001737;margin-bottom: 10px;"> Hi <b>{{ $data['name'] }} </b>,</p>
                                    ...
                                    <p style="font-family: Roboto;font-size: 14px;font-weight: normal;font-style: normal;font-stretch: normal;line-height: 1.71;letter-spacing: normal;color: #001737;"><b>Email : </b> {{ $data['email'] }}<br>
                                        <b>Password : </b> {{ $data['password'] }}</p>
                                      <p style="font-family: Roboto;font-size: 14px;font-weight: normal;font-style: normal;font-stretch: normal;line-height: 1.71;letter-spacing: normal;color: #001737;">To sign into your account, please visit <a target="new" href="{{ config('app.url') }}/login">{{ config('app.url') }}/login</a> or <a target="new" href="{{ config('app.url') }}/login">click here</a></p>
